...
.logo img{
  ...
  <div class="logo mt-5 pt-5">
    <a href="<?php echo home()?>"><img src="<?php echo home().$config['APP_ICON'];?>" alt="graphene" class="img-fluid"></a>
  </div>
  ...
  <button class="btn btn-lg btn btn-graphene btn-block" id="btn-login" name="btn-login" type="login">Sign in</button>
