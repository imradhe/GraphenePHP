...
$config  =[
        ...
        'APP_OG_ICON' => 'assets/img/GraphenePHP.png', // Size 600x300
        'APP_OG_ICON_MOBILE' => 'assets/img/GraphenePHP.png', // Size 700x700
        'APP_THEME_COLOR' => '#FFFFFF', // Color in HEX Code
        'APP_KEYWORDS' => 'GraphenePHP App, Radhe Shyam Salopanthula', // Max 20 Keywords 
